...
const DashBoardCard = ({ icons, heading, text }: DashBoardCardProps) => {
  return (
    <div className='bg-gradient-to-r from-[#1f1e24] my-3 via-[#2d2a35] to-[#1a1a1a] text-white p-6 rounded-lg shadow-lg w-full max-w-sm md:mx-4 transform transition-transform hover:scale-105'>
